...
from data_processing_utils import load_xy_pairs
...
#added flag
flags.DEFINE_string('content_dir', None, 'content input')
flags.DEFINE_string('style_dir', None, 'style input')
...
def main(unused_argv=None):
  ...
  with tf.Graph().as_default():
    ...
    with tf.device(
      ...
      #                                                  FLAGS.image_size)
      #changed
      content_inputs_, _, temp = load_xy_pairs(fake_directory=FLAGS.content_dir, real_directory=FLAGS.content_dir, batch_size=FLAGS.batch_size, prob_of_real=1)
      ...
      style_inputs_, _, temp2 = load_xy_pairs(fake_directory=FLAGS.style_dir, real_directory=FLAGS.style_dir, batch_size=FLAGS.batch_size, prob_of_real=1)
